  ...
  return (
    <>
      ...
      <div className="relative h-[50vh] md:h-[65vh] w-full overflow-hidden">
        ...
        <div className="absolute top-8 left-0 w-full px-6 md:px-12 z-30">
          <button 
            onClick={() => navigate('/artikel')}
            className="flex items-center gap-2 text-slate-900 bg-white/90 backdrop-blur-xl px-5 py-3 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl hover:bg-rose-500 hover:text-white transition-all group"
          >
      ...
      {/* JUDUL & META BOX */}
      <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl shadow-slate-200 border border-slate-50 mb-12 relative z-20">
